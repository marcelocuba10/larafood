                ...
                <div class="ibox-content">                    
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <a href="<?php echo e(route('permissions.create')); ?>" class="btn btn-primary btn-xs btn_list_options"><i class="fa fa-plus" aria-hidden="true"></i> Nuevo Permiso</a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            ...
                            <form action="<?php echo e(route('permissions.search')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <tr class="gradeA odd" role="row">
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                <a href=" <?php echo e(route('permissions.edit', $permission->id)); ?>" class="btn btn-primary btn-xs btn_list_options">
...
<?php echo $__env->make('tema.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Conecta-Desarrollo\Documents\laravel\5.8\larafood\resources\views/admin/pages/permissions/index.blade.php ENDPATH**/ ?>